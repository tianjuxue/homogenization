...
if __name__ == '__main__':
    ...
    plt.plot(strain_com, (DNS_energy_com_pore1 - DNS_energy_com_pore1[0]), '-', color='red', label='DNS ' + r'$\xi_b$')
    plt.plot(strain_ten, (DNS_energy_ten_pore1 - DNS_energy_ten_pore1[0]), '-', color='red', label='DNS ' + r'$\xi_b$')
    plt.plot(strain_com, (NN_energy_com_pore1 - NN_energy_com_pore1[0]), '--', color='red', label='NN ' + r'$\xi_b$')
    plt.plot(strain_ten, (NN_energy_ten_pore1 - NN_energy_ten_pore1[0]), '--', color='red', label='NN ' + r'$\xi_b$')
    ...
    plt.plot(strain_com, (DNS_force_com_pore1 - DNS_force_com_pore1[0]), '-', color='red', label='DNS ' + r'$\xi_b$')
    plt.plot(strain_ten, (DNS_force_ten_pore1 - DNS_force_ten_pore1[0]), '-', color='red', label='DNS ' + r'$\xi_b$')
    plt.plot(strain_com, (NN_force_com_pore1 - NN_force_com_pore1[0]), '--', color='red', label='NN ' + r'$\xi_b$')
    plt.plot(strain_ten, (NN_force_ten_pore1 - NN_force_ten_pore1[0]), '--', color='red', label='NN ' + r'$\xi_b$')
    # plt.legend(loc='upper left')
