...
if __name__ == '__main__':
    ...
    plt.plot(strain_com, (DNS_energy_com_pore0 - DNS_energy_com_pore0[0]), '-', color='blue', label='DNS ' + r'$\xi_a$')
    plt.plot(strain_ten, (DNS_energy_ten_pore0 - DNS_energy_ten_pore0[0]), '-', color='blue', label='DNS ' + r'$\xi_a$')
    plt.plot(strain_com, (NN_energy_com_pore0 - NN_energy_com_pore0[0]), '--', color='blue', label='NN ' + r'$\xi_a$')
    plt.plot(strain_ten, (NN_energy_ten_pore0 - NN_energy_ten_pore0[0]), '--', color='blue', label='NN ' + r'$\xi_a$')
    plt.plot(strain_com, (DNS_energy_com_pore2 - DNS_energy_com_pore2[0]), '-', color='red', label='DNS ' + r'$\xi_b$')
    plt.plot(strain_ten, (DNS_energy_ten_pore2 - DNS_energy_ten_pore2[0]), '-', color='red', label='DNS ' + r'$\xi_b$')
    plt.plot(strain_com, (NN_energy_com_pore2 - NN_energy_com_pore2[0]), '--', color='red', label='NN ' + r'$\xi_b$')
    plt.plot(strain_ten, (NN_energy_ten_pore2 - NN_energy_ten_pore2[0]), '--', color='red', label='NN ' + r'$\xi_b$')

    fig = plt.figure(1)
    plt.tick_params(labelsize=14)
    plt.plot(strain_com, (DNS_force_com_pore0 - DNS_force_com_pore0[0]), '-', color='blue', label='DNS ' + r'$\xi_a$')
    plt.plot(strain_ten, (DNS_force_ten_pore0 - DNS_force_ten_pore0[0]), '-', color='blue', label='DNS ' + r'$\xi_a$')
    plt.plot(strain_com, (NN_force_com_pore0 - NN_force_com_pore0[0]), '--', color='blue', label='NN ' + r'$\xi_a$')
    plt.plot(strain_ten, (NN_force_ten_pore0 - NN_force_ten_pore0[0]), '--', color='blue', label='NN ' + r'$\xi_a$')
    plt.plot(strain_com, (DNS_force_com_pore2 - DNS_force_com_pore2[0]), '-', color='red', label='DNS ' + r'$\xi_b$')
    plt.plot(strain_ten, (DNS_force_ten_pore2 - DNS_force_ten_pore2[0]), '-', color='red', label='DNS ' + r'$\xi_b$')
    plt.plot(strain_com, (NN_force_com_pore2 - NN_force_com_pore2[0]), '--', color='red', label='NN ' + r'$\xi_b$')
    plt.plot(strain_ten, (NN_force_ten_pore2 - NN_force_ten_pore2[0]), '--', color='red', label='NN ' + r'$\xi_b$')
