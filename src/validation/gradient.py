...
if __name__ == '__main__':
    ...
    for i, factor in enumerate(anneal_factors): 
        ...
        r = Expression(("0.0", "disp"), disp=factor*disp*args.n_macro*args.L0, degree=1)
        ...
        print("up")
        up_force = assemble(dot(stress, normal)[1]*ds(4))
        print(up_force)
        force.append(up_force)
    ...
    # np.save('homo_force_gradient.npy', force)
